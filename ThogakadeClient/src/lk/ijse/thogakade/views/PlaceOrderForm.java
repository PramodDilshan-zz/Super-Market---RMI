...
public class PlaceOrderForm extends javax.swing.JFrame implements Observer {
    ...
    public PlaceOrderForm() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Server Problem Please Restrat the Server");
        }
    ...
    private void initComponents() {
        ...
        orderIdText.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "  Customer Info  ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 14))); // NOI18N
        ...
        custIdCombo.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(custIdCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jButton1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 110, Short.MAX_VALUE)
                .addComponent(jLabel5)
                .addGap(18, 18, 18)
                .addComponent(txtCustomerName, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "  Customer Info  ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 14))); // NOI18N
        ...
        itemCodeCombo.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(txtQtyOnHand, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        itemTable.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        itemTable.setGridColor(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        itemTable.setRowHeight(20);
        itemTable.setRowMargin(3);
        itemTable.setSelectionBackground(new java.awt.Color(255, 153, 0));
        ...
        if (itemTable.getColumnModel().getColumnCount() > 0) {
            ...
            itemTable.getColumnModel().getColumn(2).setMinWidth(125);
            itemTable.getColumnModel().getColumn(2).setPreferredWidth(125);
            itemTable.getColumnModel().getColumn(2).setMaxWidth(125);
            itemTable.getColumnModel().getColumn(3).setMinWidth(75);
            itemTable.getColumnModel().getColumn(3).setPreferredWidth(75);
            itemTable.getColumnModel().getColumn(3).setMaxWidth(75);
            itemTable.getColumnModel().getColumn(4).setMinWidth(175);
            itemTable.getColumnModel().getColumn(4).setPreferredWidth(175);
            itemTable.getColumnModel().getColumn(4).setMaxWidth(175);
        }
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(338, 40));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(dateText, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(43, 43, 43))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (itemCodeCombo.getSelectedIndex() != -1) {
            ...
            if (txtQty.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Plese enter a valid quentity");
                txtQty.grabFocus();
                return;
            }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (!orderIdText.getText().trim().isEmpty()) {
            try {
                // Order Save
                ArrayList<OrderdetailDTO> alOrderDetails = new ArrayList<>();
                ArrayList<ItemDTO> alItemDetails = new ArrayList<>();
                ...
                for (int i = 0; i < dtm.getRowCount(); i++) {
                    ...
                    int qtyOnHandCurrent = ctrlItem.getbyId(dtm.getValueAt(i, 0).toString()).getQtyOnHand();

                    ItemDTO itemDTO = new ItemDTO(itemTable.getValueAt(i, 0).toString(),
                            txtDescription.getText(),
                            Double.parseDouble(txtUnitPrice.getText()),
                            qtyOnHandCurrent - Integer.parseInt(txtQty.getText()));
                    alItemDetails.add(itemDTO);
                    System.out.println("a " + i);
                }

                boolean result = ctrlOrder.saveOrder(orderDTO, alOrderDetails);
                if (result) {
                    for (ItemDTO itemDTO : alItemDetails) {
                ...
                if (exSql.getErrorCode() == 1062) {
                    JOptionPane.showMessageDialog(this, "Please check the Order ID once again");
                }
            } catch (Exception ex) {
                Logger.getLogger(PlaceOrderForm.class.getName()).log(Level.SEVERE, null, ex);
            }

            // For Genetating Report
            DefaultTableModel dtm = (DefaultTableModel) itemTable.getModel();
            try {
                String address = ctrlCustomer.getbyId(custIdCombo.getSelectedItem().toString()).getAddress();
                JasperReport compiledReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/thogakade/reports/Invoice.jasper"));
                HashMap<String, Object> params = new HashMap<>();
                params.put("customerName", txtCustomerName.getText());
                params.put("oderID", orderIdText.getText());
                params.put("customerAddress", address);
                params.put("Total", txtAmount.getText());
                params.put("Discount", "0");
                params.put("NetAmount", txtAmount.getText());
            ...
            JOptionPane.showMessageDialog(this, "Please Check th OrderID");
        }
    ...
    public void resetall() {
        DefaultTableModel dtm = (DefaultTableModel) itemTable.getModel();
        dtm.setRowCount(0);
        itemCodeCombo.setSelectedIndex(0);
