...
public class ItemForm extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(907, 400));
        setMinimumSize(new java.awt.Dimension(907, 400));
        setPreferredSize(new java.awt.Dimension(907, 400));
        ...
        txtQtyOnHand.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        txtPrice.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtQtyOnHand, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jButton3.setToolTipText("Search From Here");
        ...
        tblItem.setBackground(new java.awt.Color(255, 255, 204));
        tblItem.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        tblItem.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Item ID", "Description", "Price", "Qty On Hand"
            }
        ) {
        ...
        tblItem.setGridColor(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        tblItem.setRequestFocusEnabled(false);
        tblItem.setRowHeight(20);
        tblItem.setRowMargin(3);
        tblItem.setSelectionBackground(new java.awt.Color(255, 153, 0));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (txtID.getText().trim().isEmpty() || txtName.getText().trim().isEmpty()
                || txtPrice.getText().trim().isEmpty() || txtQtyOnHand.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enetr data to the fields");
            return;
        } else {
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            ...
            JasperReport compiledReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/thogakade/reports/PrintItemTable.jasper"));
    ...
    private void btnPrintOneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintOneActionPerformed
        ...
        try {
            ...
            JasperReport compiledReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/thogakade/reports/ItemPrint2.jasper"));
            HashMap<String, Object> params = new HashMap<>();
            params.put("Item Code", " " + txtID.getText());
            params.put("description", " " + txtName.getText());
            params.put("qtyOnHand", txtQtyOnHand.getText() + "   ");
